...
export default function BackgroundFX() {
  ...
  useEffect(() => {
    ...
    const blobs = [
      { x: 0.16, y: 0.14, r: 0.4, c: '139,92,246', fx: 0.00013, fy: 0.0001, phase: 0 },
      { x: 0.84, y: 0.7, r: 0.36, c: '255,176,32', fx: -0.0001, fy: 0.00014, phase: 2.1 },
      { x: 0.5, y: 0.28, r: 0.3, c: '255,61,129', fx: 0.00015, fy: -0.00011, phase: 4.4 },
      { x: 0.28, y: 0.78, r: 0.26, c: '34,211,238', fx: -0.00012, fy: -0.00009, phase: 1.3 },
    ];

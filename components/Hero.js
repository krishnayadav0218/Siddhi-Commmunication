  ...
  return (
    <section id="home" className="wrap hero">
      ...
      <div className="hero-visual" ref={visualRef}>
        <div className="phone-stage" ref={phoneRef}>
          {hero.heroImage ? (
            <div className="shop-photo-frame">
            ...
            <div className="phone-body">
              ...
              <div className="phone-screen">
                ...
                <div className="brandmark">SIDDHI</div>
              </div>
            </div>
          )}
          <div className="float-badge badge-earbuds"><span className="ic">🎧</span> TWS Earbuds</div>
          <div className="float-badge badge-cable"><span className="ic">🔌</span> Fast-C Cable</div>
          <div className="float-badge badge-glass"><span className="ic">🛡️</span> UV Tempered Glass</div>
        </div>
      </div>
    </section>
  );

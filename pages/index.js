  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="icon"
          href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Crect width='24' height='24' rx='6' fill='%23080911'/%3E%3Cpath d='M12 3L5 6.5v6c0 4.5 3 7.7 7 9 4-1.3 7-4.5 7-9v-6z' fill='%23159ba0'/%3E%3Cpath d='M9.3 12l1.8 1.8L15 10' stroke='%23f2a324' stroke-width='1.6' fill='none' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E"
        />
        <script

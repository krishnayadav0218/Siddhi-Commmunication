...
const s = {
  ...
  tabBtnActive: { background: 'rgba(139,92,246,.15)', borderColor: 'rgba(139,92,246,.4)', color: '#d9b3ff' },
  ...
  stars: { color: '#ffb020', fontSize: 13 },
  ...
  btnReject: { padding: '8px 14px', borderRadius: 100, border: '1px solid rgba(255,197,66,.4)', background: 'rgba(255,197,66,.1)', color: '#ffd666', fontSize: 12, fontWeight: 700, cursor: 'pointer' },

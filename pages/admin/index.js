  ...
  return (
    <>
      ...
      <div style={s.page}>
        ...
        <Section title="Flash Sale / Offer Countdown">
          <label style={s.checkboxRow}>
            <input
              type="checkbox"
            ...
            />
            <span>Show flash sale banner (hides automatically once it ends)</span>
          </label>
          <Field label="Offer title" value={content.flashSale.title} onChange={(v) => update(['flashSale', 'title'], v)} />
          <Field label="Offer description" value={content.flashSale.desc} onChange={(v) => update(['flashSale', 'desc'], v)} />
          <Field
          ...
          />
          <p style={s.helperText}>Use IST offset (+05:30) so the countdown matches Indian time exactly.</p>
        </Section>

...
const s = {
  ...
  logoBadge: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    boxShadow: '0 0 22px -4px #8b5cf6, 0 0 30px -8px #ffb020',
  },
  ...
  btnSave: {
    ...
    borderRadius: 100,
    border: 'none',
    background: 'linear-gradient(120deg,#ffb020,#e8890a)',
    color: '#171200',
    fontSize: 14.5,
    fontWeight: 800,
    cursor: 'pointer',
    boxShadow: '0 10px 24px -8px rgba(255,176,32,.5)',
  },
};
